...
Revision ID: 7ce55b4a4497
Revises: b53a596903d1
Create Date: 2021-10-20 15:06:58.049594
...
revision = '7ce55b4a4497'
down_revision = 'b53a596903d1'
branch_labels = None
depends_on = None
...
def upgrade():
    ...
    sa.UniqueConstraint('abbreviation_corevariable')
    )
    ...
    sa.Column('technology_study', sa.String(length=50), nullable=True),
