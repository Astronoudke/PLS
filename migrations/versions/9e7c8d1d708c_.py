...
Revision ID: 9e7c8d1d708c
Revises: f6c80d8df78b
Create Date: 2021-10-12 11:23:05.359036
...
revision = '9e7c8d1d708c'
down_revision = 'f6c80d8df78b'
branch_labels = None
depends_on = None
...
def upgrade():
    ...
    sa.Column('linked_model', sa.Integer(), nullable=True),
    sa.ForeignKeyConstraint(['linked_model'], ['utau_tmodel.id'], ),
    sa.PrimaryKeyConstraint('id')
    )
